...
//  if (EthStatus == (ETH_INIT_FLAG | ETH_LINK_FLAG)) changed this
//  { changed this
    /* Set Ethernet link flag */
 //   xnetif.flags |= NETIF_FLAG_LINK_UP; changed this
...
//    LCD_SetTextColor(White);
 ...
 // netif_set_link_callback(&xnetif, ETH_link_callback); changed this
}
